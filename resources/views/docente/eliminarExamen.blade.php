...
<div style="background: #C10000; width:500px;" class="block formulario my-12 p-8 ">
  ...
  <form class="mt-4" method="POST" action="">
    ...
    <div class="flex justify-center">
        <div class="mb-3 xl:w-96">
          <select class="form-select appearance-none
            ...
            ease-in-out
            m-0
            focus:d focus:bg-white focus:border-blue-600 focus:outline-none" aria-label="Default select example" id="opcion" name="mi_select">
    ...
    text-white font-semibold p-2 my-3">Eliminar</button>
  </form>
</div>
</div>
